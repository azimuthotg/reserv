...
next:
  ...
  - **deploy QR ขนาดใหม่ขึ้น prod** — `git pull` + `collectstatic` (มีไฟล์ static ใหม่ `booking/js/qr.js`) · **ไม่ต้อง restart** เพราะไม่ได้แก้ Python code · แล้วเปิด `/card-login/` เช็คว่า QR ใหญ่ขึ้นจริง
risks:
