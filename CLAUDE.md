...
next:
  - **ส่งหนังสือแจ้งทีม VM ว่าผูกปุ่มเสร็จแล้ว** เพื่อให้เขาปิดช่องทางเดิม `http://202.29.55.180:8888` (ข้อ 10.5 ของหนังสือ 10 ส.ค.) — ร่างเนื้อหาให้แล้วในเซสชัน 10 ส.ค. ผู้ใช้ส่งเอง
