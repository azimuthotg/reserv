...
next:
  - **ส่งหนังสือให้ทีม VM Gateway 3 ฉบับ** — [reply-vm-gateway](doc/reply-vm-gateway-2026-08-08.md) (canva2) · [reply-vm-overlap](doc/reply-vm-overlap-2026-08-08.md) (กติกาทับเวลา) · [reply-vm-afterhours](doc/reply-vm-afterhours-2026-08-08.md) (จองนอกเวลา — ขอให้เขาเช็คว่า Gateway เปิด session ได้ 24 ชม. + แจ้งช่วงบำรุงรักษาเครื่องแม่)
...
**บริการออนไลน์ (เครื่องเสมือน) เปิด 24 ชม.:** `Canva Pro 1`, `Canva Pro 2`, `Netflix Pro`
เข้าใช้แบบ remote ไปที่เครื่องแม่ ไม่ต้องเข้าอาคาร จองได้ `00:00 – 23:59` **ทุกวันรวมวันหยุด**
