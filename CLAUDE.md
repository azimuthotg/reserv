...
next:
  ...
  - **deploy รูปห้อง 3 ใบ + กล่องรูป 16:9 ขึ้น prod** — `git pull` + `collectstatic --noinput` + **`nssm restart Reserv`** (รอบนี้แก้ template ด้วย ต้อง restart) แล้วเช็คหน้าแรกว่าเห็นชื่อบริการบนรูปครบทั้ง 3 ห้อง
