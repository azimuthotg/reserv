...
class RoomForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'day_round_enabled': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
        ...
        labels = {
            ...
            'is_online':         'บริการออนไลน์ — จองนอกเวลาทำการและวันหยุดได้',
            'day_round_enabled': 'เปิดจองรอบกลางวัน (08:30–17:00)',
