...
📌 **สเปกรูปห้อง:** `booking/static/booking/images/rooms/<booking_name>.png` · **1920×1080**
· PNG quantize 256 สี + dither (เต็มสีจากภาพ AI ได้ ~1.9 MB ใหญ่เกินไป · 256 สีเหลือ ~0.6 MB
และตรวจแล้วไม่เห็น banding บนพื้นไล่เฉด) · **ต้อง `git add -f` เพราะ .gitignore บรรทัด 38 ignore `*.png`**
